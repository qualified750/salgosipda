...
<head>
    ...
    <script type="text/javascript"
        src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=aor0d1613z&submodules=geocoder"></script>
...
<body>
    ...
    <header>
        ...
        <div class="header">
            <div id="home"><a href="http://salgosipda.iptime.org/salgosipda/" class="land">SALGO</a>
            ...
            .ready(
                function () {
                    ...
                    function getAvailableEstates(map) {
                        var url = "http://salgosipda.iptime.org/salgosipda/"
                            + "availableEstates/"
